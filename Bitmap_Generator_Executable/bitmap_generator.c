...
int main(int argc, char* argv[])
{
	...
	if (radius >= MIN_DEFORMITY_RADIUS && radius < 33)
	{

	imageFileName = "bitmap" + std::string("NO") + std::to_string(imageNum) + ".jpg";

	}

	if (radius >= 33 && radius < 46)
	{

	imageFileName = "bitmap" + std::string("LOW") + std::to_string(imageNum) + ".jpg";

	}

	if (radius >= 46 && radius < 112)
	{

	imageFileName = "bitmap" + std::string("MED") + std::to_string(imageNum) + ".jpg";
	
	}

	if (radius >= 112 && radius < 141)
	{

	imageFileName = "bitmap" + std::string("HIGH") + std::to_string(imageNum) + ".jpg";
